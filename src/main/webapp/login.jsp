...
<head>
	...
	<!-- 引入bootstrap -->
	<link rel="stylesheet" type="text/css" href="bootstrap4.0/css/bootstrap.min.css">
	<!-- 引入JQuery  bootstrap.js-->
	<script src="bootstrap4.0/js/jquery-3.2.1.min.js"></script>
	<script src="bootstrap4.0/js/bootstrap.min.js"></script>
	<style type="text/css">
	body{
	   background: url(bootstrap4.0/images/a.jpg) no-repeat;
